 ...
 * @author Ribañez
 */
public class MenuPrincipal11 extends javax.swing.JFrame {

    /**
     * Creates new form MenuPrincipal
     */
    public MenuPrincipal11() {
    ...
    private void BotonClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonClientesActionPerformed
     Clientes cli = null;
        try {
            ...
            Logger.getLogger(MenuPrincipal11.class.getName()).log(Level.SEVERE, null, ex);
        }
            cli.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPrincipal11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MenuPrincipal11().setVisible(true);
            }
        });
    }
